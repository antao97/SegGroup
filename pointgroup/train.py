...
def train_epoch(train_loader, model, model_fn, optimizer, epoch):
    ...
    for i, batch in enumerate(train_loader):
        ...
        sys.stdout.write(
            "\repoch: {}/{} iter: {}/{} loss: {:.4f}({:.4f}) data_time: {:.2f}({:.2f}) iter_time: {:.2f}({:.2f}) remain_time: {remain_time}".format
...
if __name__ == '__main__':
    ...
    ##### resume
    # model.cpu()
    # model.load_state_dict(torch.load('/data1/antao/Documents/CVPR2021/One-Thing-One-Click/pretrained/pointgroup_run1_scannet-000001250.pth'), strict=False)
    # model.cuda()
